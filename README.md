...
| 文档 | 内容 |
| --- | --- |
| [docs/INSTALL.md](docs/INSTALL.md) | **安装与使用手册**：环境准备、分步安装、手机访问、页面操作说明、常见问题排查 |
| [docs/API.md](docs/API.md) | 后端接口文档：四个接口的参数与返回示例 |
| [docs/MODEL.md](docs/MODEL.md) | 模型说明：特征公式、状态分类规则、评分表、概率转换、回测方法与模型局限 |
